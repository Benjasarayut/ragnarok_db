...
option {
  background-color: #1e293b; /* สีพื้นหลัง dropdown */
  color: #e2e8f0;            /* สีข้อความ */
}
...
<header class="topnav">
  <div class="logo"><h1>👑 Ragnarok Admin Dashboard</h1></div>
    ...
    <div class="box">
      ...
      <table>
        ...
        <tbody>
          ...
          <?php endforeach; else: ?>
            <tr><td colspan="6" style="text-align:center;">ไม่มีข้อมูลผู้เล่น</td></tr>
          <?php endif; ?>
        </tbody>
      </table>
    </div>
  ...
  <section id="message_history" class="page">
    <div class="box">
      ...
      <table id="messageTable">
        <thead><tr><th>ID</th><th>ผู้ส่ง</th><th>ผู้รับ</th><th>ข้อความ</th><th>วันที่ส่ง</th></tr></thead>
        <tbody></tbody>
      </table>
    </div>
  </section>
...
<section id="ban" class="page">
  ...
  <section id="ban_history" class="page">
    <div class="box">
      ...
      <table id="banTable">
        <thead><tr><th>Ban ID</th><th>Player ID</th><th>Start</th><th>End</th><th>Reason</th><th>Created</th><th>Action</th></tr></thead>
        <tbody></tbody>
      </table>
    </div>
  </section>
...
function banPlayer(e) {
  ...
  fetch("../api/ban_player.php", {
    method: "POST",
    headers: {"Content-Type": "application/json"},
    body: JSON.stringify({ player_id, start_date, end_date, reason })
  })
  .then(res => res.json())
  .then(r => {
